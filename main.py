...
parser.add_argument('--unbounded_eval_hist', default=True, action='store_true')
...
parser.add_argument('--history_length', type=int, default = 80)
...
if __name__ == "__main__":
    ...
    wrt_csv_eval.write({'nupdates':update_iter,
                       ...
                       'sampling_loop':sampling_loop})
    wrt_csv_eval.close()
    print(f'Done, stored at dir {log_file_dir}')